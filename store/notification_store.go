...
type NotificationStore interface {
	...
	GetByID(ctx context.Context, id uuid.UUID) (*types.Notification, error)
	...
	GetByUser(ctx context.Context, userID uuid.UUID, limit, offset int, status *bool) ([]types.Notification, error)
