...
// @Router /v1/trips/{id}/chat/messages [post]
func (h *ChatHandler) SendMessage(c *gin.Context) {
	...
	if h.notificationService != nil && h.notificationService.IsEnabled() {
		go func() {
			...
			members, err := h.tripService.GetTripMembers(notifCtx, tripID)
			if err != nil {
			...
			for _, member := range members {
				if member.UserID != supabaseUserID && member.DeletedAt == nil {
			...
			if len(recipientIDs) > 0 {
				if err := h.notificationService.SendChatMessage(notifCtx, recipientIDs, data); err != nil {
...
// @Failure 403 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
// @Router /v1/trips/{id}/chat/messages [get]
...
// @Failure 403 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
// @Router /v1/trips/{id}/chat/messages/{messageId}/reactions [post]
...
// @Failure 403 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
// @Router /v1/trips/{id}/chat/messages/{messageId}/reactions/{emoji} [delete]
...
// @Failure 403 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
// @Router /v1/trips/{id}/chat/messages/read [put]
func (h *ChatHandler) UpdateReadStatus(c *gin.Context) {
	tripID := c.Param("id")
	// Use Supabase user ID for trip access validation
	supabaseUserID := c.GetString(string(middleware.UserIDKey))
