...
// @Param request body types.AddMemberRequest true "Member details"
// @Success 201 {object} types.TripMemberResponse "Successfully added member"
...
// @Param request body types.UpdateMemberRoleRequest true "New role"
// @Success 200 {object} types.TripMemberResponse "Successfully updated member's role"
...
// @Produce json
// @Param tripId path string true "Trip ID"
// @Success 200 {array} types.TripMemberDetailResponse "List of trip members with profile information"
// @Failure 401 {object} types.ErrorResponse "Unauthorized - User not logged in"
